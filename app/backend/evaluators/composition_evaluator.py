...
import asyncio
from app.utils.database.database import AsyncConnectionPool, MappingUtilites
...
class CompositionEvaluator(SP.StreamProcessor):
    ...
    def evaluate_sleuth_rules(self, composition, rules):
        encounter_orders = composition.get_encounter_orders()
        encounter_dx = composition.get_encounter_problem_list()
