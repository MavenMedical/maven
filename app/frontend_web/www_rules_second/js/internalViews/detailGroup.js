        ...
        render: function(){
            ...
            var detailLine = Backbone.View.extend({
                ...
                initialize: function(params){
                    ...
                    //if there are conflicts in the details add the conflict css to the model IF its dertail ID is within a conflict
                    ...
                    $('.remove-detail', this.$el)[0].onclick = function(){
                        ...
                        //tell the ui that the rule has been changed since load
