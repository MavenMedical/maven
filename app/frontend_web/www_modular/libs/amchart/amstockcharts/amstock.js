AmCharts.AmStockChart = AmCharts.Class({construct: function (a) {
    ...
    var b = this.theme, c = this.exportConfig;
    ...
    var a = this.comparedDataSets, b = this.categoryAxesSettings,
        c;
    ...
    if (a) {
        ...
        var h = this.leftContainer, f = this.rightContainer, g = this.centerContainer, k = this.panelsContainer, m = a.width + 2 * c + "px";
        switch (a.position) {
            case "left":
                h.style.width =
                    a.width + "px";
    ...
    if (a) {
        ...
        this.dssContainer = d;
        var e = this.leftContainer, h = this.rightContainer, f = this.centerContainer, g = this.panelsContainer, c = a.width + 2 * c + "px";
        switch (b) {
            case "left":
    ...
    handlePeriodSelectorZoom: function (a) {
        ...
        var c = this, d = c.firstDate, e = c.lastDate, h = c.currentPeriod, f = c.categoryAxesSettings, g = f.minPeriod, k = c.panelsSettings, m = c.periodSelector, p = c.panels, y = c.comparedGraphs, t = c.scrollbarChart, x = c.firstDayOfWeek;
        if (d && e) {
            a || (a = d);
            b || (b = e);
            if (h) {
            ...
            {type: "zoomed"}, m.startDate = a, m.endDate = b, m.chart = c, m.period = h, c.fire(m.type, m), c.previousStartDate = new Date(a), c.previousEndDate = new Date(b)
        }
        c.eventsHidden && c.showHideEvents(!1);
        c.chartCreated || (h = "init", c.fire(h, {type: h, chart: c}));
        c.chartRendered || (h = "rendered", c.fire(h, {type: h, chart: c}), c.chartRendered = !0);
        h = "drawn";
        ...
        if (0 < this.dataSets.length) {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                for (f = 0; f < h.length; f++) {
                    var g = h[f], g = AmCharts.processObject(g, AmCharts.StockGraph, this.theme);
                    h[f] = g;
                    ...
                    var m = c.stockLegend, p, y, t, x;
                    m && (m = AmCharts.processObject(m, AmCharts.StockLegend, this.theme), c.stockLegend = m, p = m.valueTextComparing, y = m.valueTextRegular, t = m.periodValueTextComparing, x = m.periodValueTextRegular);
                    if (g.comparable) {
                        var u = e.length;
                        ...
                        var n;
                        for (n = 0; n < u; n++) {
                            var w = e[n], q = g.comparedGraphs[w.id];
                            q || (q = new AmCharts.AmGraph(this.theme), q.id = "comparedGraph" + n + "_" + w.id);
                            q.periodValue = g.periodValue;
                            q.dataSet = w;
                            g.comparedGraphs[w.id] = q;
                            q.seriesIdField = "amCategoryIdField";
                            q.connect = g.connect;
                            var l = g.compareField;
                            l || (l = g.valueField);
                            var D = !1, A = w.fieldMappings, z;
                            ...
                            if (D) {
                                ...
                                isNaN(l) || (q.lineThickness = l);
                                l = g.compareGraphDashLength;
                                isNaN(l) || (q.dashLength = l);
                                l = g.compareGraphLineAlpha;
                                isNaN(l) || (q.lineAlpha = l);
                                l = g.compareGraphCornerRadiusTop;
                                isNaN(l) || (q.cornerRadiusTop = l);
                                l = g.compareGraphCornerRadiusBottom;
                                isNaN(l) || (q.cornerRadiusBottom = l);
                                l = g.compareGraphBalloonColor;
                                isNaN(l) || (q.balloonColor = l);
                                if (l = g.compareGraphFillColors)q.fillColors = l;
                                if (l = g.compareGraphNegativeFillColors)q.negativeFillColors =
                                    l;
                                if (l = g.compareGraphFillAlphas)q.fillAlphas = l;
                                if (l = g.compareGraphNegativeFillAlphas)q.negativeFillAlphas = l;
                                if (l = g.compareGraphBullet)q.bullet = l;
                                if (l = g.compareGraphNumberFormatter)q.numberFormatter = l;
                                if (l = g.compareGraphBalloonText)q.balloonText = l;
                                l = g.compareGraphBulletSize;
                                isNaN(l) || (q.bulletSize = l);
                                l = g.compareGraphBulletAlpha;
                                isNaN(l) || (q.bulletAlpha = l);
                                l = g.compareGraphBulletBorderAlpha;
                                isNaN(l) || (q.bulletBorderAlpha = l);
                                if (l = g.compareGraphBulletBorderColor)q.bulletBorderColor = l;
                                l = g.compareGraphBulletBorderThickness;
                                isNaN(l) || (q.bulletBorderThickness = l);
                                q.visibleInLegend = g.compareGraphVisibleInLegend;
                                q.balloonFunction = g.compareGraphBalloonFunction;
                                q.valueAxis = g.valueAxis;
                                m && (k && p ? (q.legendValueText = p, q.legendPeriodValueText = t) : (y && (q.legendValueText = y), x && (q.legendPeriodValueText = x)));
                                c.addGraph(q);
                                this.comparedGraphs.push({graph: q, dataSet: w})
                            }
                        }
                    }
                    m && (k && p ? (g.legendValueText = p, g.legendPeriodValueText = t) : (y && (g.legendValueText = y), x && (g.legendPeriodValueText = x)))
                }
            }
        }
    }, choosePeriod: function (a, b, c) {
        var d = this.categoryAxesSettings,
            e = d.groupToPeriods, h = e[a], e = e[a + 1], f = AmCharts.extractPeriod(h), f = AmCharts.getPeriodDuration(f.period, f.count), g = b.getTime(), k = c.getTime(), d = d.maxSeries;
...
AmCharts.PeriodSelector = AmCharts.Class({construct: function (a) {
    ...
    if (b.inputFieldsEnabled) {
        ...
        b.startDateField = k;
        if (d)g = b.width -
            6 + "px", AmCharts.addBr(f); else {
            var g = b.inputFieldWidth + "px", m = document.createTextNode(" ");
            f.appendChild(m)
        }
        k.style.width = g;
    ...
    if (AmCharts.ifArray(f)) {
        ...
        b.periodContainer = g;
        var p;
        for (a = 0; a < f.length; a++)k = f[a], p = document.createElement("input"), p.type = "button", p.value =
            k.label, p.period = k.period, p.count = k.count, p.periodObj = k, p.className = "amChartsButton", c && AmCharts.applyStyles(p.style, c.PeriodButton), d && (p.style.width = b.width - 1 + "px"), p.style.boxSizing = "border-box", g.appendChild(p), b.addEventListeners(p), k.button = p;
        !d && p && (h = p.offsetHeight);
    ...
    var d = a.button, e = d.count, h = d.period, f, g, k = this.firstDate, m = this.lastDate, p, y = this.theme;
    k && m && ("MAX" == h ? (f = k, g = m) : "YTD" == h ? (f = new Date, f.setMonth(0, 1), f.setHours(0, 0, 0, 0), 0 === e && f.setDate(f.getDate() - 1), g = this.lastDate) : (p = AmCharts.getPeriodDuration(h,
        ...
        y.PeriodButtonSelected), a = {type: "changed"}, a.startDate = f, a.endDate = g, a.predefinedPeriod = h, a.chart = this.chart, a.count = e, a.event = c, this.fire(a.type, a)))
}, markButtonAsSelected: function () {
    if (!this.skipMark) {
        var a = this.chart, b = this.periods, c = a.startDate.getTime(), a = a.endDate.getTime(), d = this.theme;
        this.unselectButtons();
        var e;
        for (e = b.length - 1; 0 <= e; e--) {
            var h = b[e], f = h.button;
...
AmCharts.StockPanel = AmCharts.Class({inherits: AmCharts.AmSerialChart, construct: function (a) {
    ...
    var a = this, b = a.iconSize, c = a.container, d = a.pathToImages, e = a.realWidth - 2 * b - 1 - a.marginRight, h = AmCharts.rect(c, b, b, "#000", 0.005), f = AmCharts.rect(c, b, b, "#000", 0.005);
    f.translate(b + 1, 0);
    ...
    this.drawOnAxis = b;
    var c = this.categoryAxis, d = a.initialX, e = a.finalX, h = a.initialY;
    a = a.finalY;
...
AmCharts.parseStockData = function (a, b, c, d, e) {
    (new Date).getTime();
    var h = {}, f = a.dataProvider, g = a.categoryField;
    if (g) {
        var k = AmCharts.getItemIndex(b, c), m = c.length, p, y = f.length, t, x = {};
        for (p = k; p < m; p++)t = c[p], h[t] = [];
        var u = {}, n = a.fieldMappings, w = n.length;
        for (p = 0; p < y; p++) {
            var q = f[p], l = q[g], l = l instanceof Date ? "fff" == b ? AmCharts.useUTC ? new Date(l.getUTCFullYear(), l.getUTCMonth(), l.getUTCDate(), l.getUTCHours(), l.getUTCMinutes(), l.getUTCSeconds(), l.getUTCMilliseconds()) : new Date(l.getFullYear(), l.getMonth(),
                l.getDate(), l.getHours(), l.getMinutes(), l.getSeconds(), l.getMilliseconds()) : new Date(l) : e ? AmCharts.stringToDate(l, e) : new Date(l), D = l.getTime(), A = {};
            for (t = 0; t < w; t++)A[n[t].toField] = q[n[t].fromField];
            var z;
            for (z = k; z < m; z++) {
                t = c[z];
                var s = AmCharts.extractPeriod(t), B = s.period, E = s.count, v, r;
                if (z == k || D >= x[t] || !x[t]) {
                    u[t] = {};
                    ...
                    if (z == k)for (var F in q)q.hasOwnProperty(F) && (u[t][F] = q[F]);
                    u[t][g] = new Date(l)
                } else for (B = 0; B < w; B++)s = n[B].toField, v = u[t], p == y - 1 && (v[g] = new Date(l)), r = Number(A[s]), isNaN(r) || (isNaN(v[s + "Low"]) && (v[s + "Low"] = r), r < v[s + "Low"] && (v[s + "Low"] = r), isNaN(v[s + "High"]) && (v[s + "High"] = r),
...
AmCharts.parseEvents = function (a, b, c, d, e, h) {
    var f = a.stockEvents, g = a.agregatedDataProviders, k = b.length, m, p, y, t, x, u, n, w;
    for (m = 0; m < k; m++) {
        u = b[m];
        x = u.graphs;
        y = x.length;
        var q;
        for (p = 0; p < y; p++)t = x[p], t.customBulletField = "amCustomBullet" + t.id + "_" + u.id, t.bulletConfigField = "amCustomBulletConfig" + t.id + "_" + u.id;
        for (var l = 0; l < f.length; l++)if (n = f[l], q = n.graph, AmCharts.isString(q) && (q = AmCharts.getObjById(x, q)))n.graph = q
    }
    for (var D in g)if (g.hasOwnProperty(D)) {
        q = g[D];
        var A = AmCharts.extractPeriod(D), z = q.length, s;
        for (s =
                 0; s < z; s++) {
            var B = q[s];
            m = B[a.categoryField];
            ...
            for (m = 0; m < k; m++)for (u = b[m], x = u.graphs, y = x.length, p = 0; p < y; p++) {
                t = x[p];
                var r = {};
                r.eventDispatcher = e;
                r.eventObjects = [];
...
AmCharts.DataSetSelector = AmCharts.Class({construct: function (a) {
    ...
    if (1 < b.countDataSets("showInSelect")) {
        ...
        for (c = 0; c < e.length; c++)if (g = e[c], !0 === g.showInSelect) {
    ...
    if (0 < b.countDataSets("showInCompare") && 1 < e.length)if (h ? (AmCharts.addBr(a),
    ...
    for (d = 0; d < c.length; d++)e = c[d], e.compared && (a = {type: "dataSetUncompared", dataSet: e}), e.compared = !1;
    c = b.selectedIndex;
    0 < c && (e = this.dataProvider[b.options[c].value],
        e.compared || (a = {type: "dataSetCompared", dataSet: e}), e.compared = !0);
    b = this.chart;
    b.validateData();
    a.chart = b;
    this.fire(a.type, a)
...
AmCharts.StackedBullet = AmCharts.Class({construct: function () {
    ...
    b = d.set();
    var e = -1, h = this.stackDown;
    this.showOnAxis && (this.stackDown = this.graph.valueAxis.reversed ? !0 : !1);
    this.stackDown &&
    (e = 1);
    var f = 0, g = 0, k = 0, m, k = this.fontSize, p = this.mastHeight, y = this.shape, t = this.textColor;
    ...
    var b = -1;
    this.stackDown && (b = 1);
    var c = this.mastHeight * b, d = this.fontSize / 2 + 2, e = AmCharts.line(this.container, [0, 0], [0, c], this.borderColor, this.borderAlpha, 1), h = AmCharts.circle(this.container, d, this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
    h.translate(0, c + d * b);
    a.push(e);
    a.push(h);
    this.set.push(a);
