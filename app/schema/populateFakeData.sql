...
INSERT INTO costmap(
            ...
            cost)
    VALUES (1, '76370', 'HCPCS', '286', -1, '5',
            807.00);

INSERT INTO costmap(
            customer_id, code, code_type, department, cost_type, orderable_id,
            cost)
    VALUES (1, '70470', 'HCPCS', '-1', -1, '18724',
            792.78);

INSERT INTO costmap(
            customer_id, code, code_type, department, cost_type, orderable_id,
            cost)
    VALUES (1, '72191', 'HCPCS', '286', -1, '72191',
            742.79);

INSERT INTO costmap(
            customer_id, code, code_type, department, cost_type, orderable_id,
            cost)
    VALUES (1, '25033', 'rxnorm', '-1', -1, '3',
            519.14);

INSERT INTO costmap(
            customer_id, code, code_type, department, cost_type, orderable_id,
            cost)
    VALUES (1, '82784', 'HCPCS', '286', -1, '2',
            16.14);

INSERT INTO rules.evirule(
            ruleid, name, minage, maxage, sex, codetype, fullspec, comments,
            remainingdetails)
    VALUES (109274, 'ACR 5', 0.00, 200.00, '%', 'CPT', '{"details":[{"id":0,"type":"historic_dx","exists":false,"snomed":445039006, "frame_min":-100000, "frame_max":0},{"id":1,Age:15:200}]}', NULL,
