...
delete from transparent.costmap where customer_id=-1;
delete from public.orderable where customer_id=-1;
\copy transparent.costmap from 'data/CostMapDefaults.csv' DELIMITER ','  null as '' CSV
\copy public.orderable(customer_id,orderable_id,ord_type,system,name,description,status,source,cpt_code,cpt_version) from 'data/OrderableDefaults.csv' DELIMITER ',' null as '' quote as '"' CSV
