...
class PostgresFHIR():
    ...
    def write_composition_to_db(self, composition, conn):
        self.write_composition_patient(composition, conn)
        self.write_composition_encounter(composition, conn)
        self.write_composition_json(composition, conn)
        self.write_composition_encounterdx(composition, conn)
        self.write_composition_encounter_orders(composition, conn)

    def write_composition_patient(self, composition, conn):
        try:
    ...
    def write_composition_encounter(self, composition, conn):
        try:
            pat_id = composition.subject.get_pat_id()
            customer_id = composition.customer_id
    ...
    def write_composition_json(self, composition, conn):
        try:
            pat_id = composition.subject.get_pat_id()
            customer_id = composition.customer_id
            encID = composition.encounter.get_csn()
    ...
    def write_composition_encounterdx(self, composition, conn):
        try:
            pat_id = composition.subject.get_pat_id()
            customer_id = composition.customer_id
            encID = composition.encounter.get_csn()
    ...
    def write_composition_encounter_orders(self, composition, conn):
        try:
            pat_id = composition.subject.get_pat_id()
            customer_id = composition.customer_id
            encID = composition.encounter.get_csn()
